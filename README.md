...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-q6onsoy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-q6onsoy.containers.anotherwebservice.com/
...
```
git clone git@github.com:daekydev/container-q6onsoy.git
cd container-q6onsoy
```
...
```
docker attach container-q6onsoy
```
